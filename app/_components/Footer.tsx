      ...
      <div className="flex flex-col items-center justify-center gap-6 py-8 px-4">
        ...
        <div className="flex items-center justify-center gap-5">
          ...
          <a
            ...
            className="group relative p-2.5 text-slate-400 dark:text-slate-500 hover:text-slate-900 dark:hover:text-slate-100 transition-all duration-300"
          ...
          >
            ...
            {/* 호버 시 뒤에 나타나는 원형 배경 효과 */}
            <span className="absolute inset-0 rounded-full bg-slate-100 dark:bg-slate-800 scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-300 -z-10" />
          </a>
