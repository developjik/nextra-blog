  ...
  return (
    <NextraFooter>
      <div className="flex flex-col items-center justify-center gap-6 py-8 px-4">
        ...
        >
          <time className="font-bold" style={{ color: 'var(--color-accent)' }}>
            {currentYear}
          </time>
          <span style={{ color: 'var(--swiss-gray)' }}>•</span>
          <span className="font-bold" style={{ color: 'var(--swiss-black)' }}>
            developjik
          </span>
        </div>
        ...
        <div className="flex items-center justify-center gap-5">
          ...
          >
            ...
            <span
              className="absolute inset-0 rounded-full scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-300 -z-10"
