...
const featuredProjects = [
  {
    ...
    summary:
      'Next.js App Router + Nextra 기반 기술 블로그 구축 및 콘텐츠 운영 자동화',
    href: '/about',
        ...
        <div className="grid-swiss">
          <div className="col-span-12 text-center">
            <ScrollReveal variant="up">
              ...
              >
                사용자 경험과 성능 최적화를 중요하게 생각하는 프론트엔드
                개발자입니다. 이 블로그는 이직을 위한 대표 프로젝트, 문제 해결
                기록, 기술 아티클을 한 번에 볼 수 있는 공간입니다.
              </p>
            </ScrollReveal>

            <ScrollReveal variant="up" delay={100}>
              <div className="flex flex-wrap justify-center gap-4 mt-10">
                <a href="/about" className="btn-swiss">
                  ABOUT ME
                </a>
              ...
              {featuredPosts.map((post) => (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <h3 className="text-h3 group-hover:text-[var(--color-accent)] transition-colors">
                      {post.title}
                    </h3>
            ...
            <div className="card-swiss">
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="btn-swiss btn-swiss-outline w-full"
                >
                  EMAIL
                </a>
                <a href="/about" className="btn-swiss btn-swiss-outline w-full">
                  CAREER SUMMARY
                </a>
              </div>
            </div>
